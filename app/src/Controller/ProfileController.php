...
{   
    ...
    public function editUserProfile(Request $request, UserRepository $users, SluggerInterface $slugger, MiniTwitsRepository $miniTwits): Response
    {   
        /** @var User $user */
        $user=$this->getUser();
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            if($backgroundImageFile){
                ...
                try {
                    $backgroundImageFile->move(
                        $this->getParameter('background_directory'), 
                        $newBackgroundName
                    );
            ...
            return $this->redirectToRoute('app_mini_twits_profile');
        }
